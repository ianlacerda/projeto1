<?php 
    include("conexao.php") ;
    try{
        $sql = "insert into tbl_funcs (email,nome,data_acesso) values(:email,:nome,:data_acesso)";
...
<body>
    ...
    <br>
    <div class="row">
    <label class="form-label">Data de Acesso</label><input type="date" name="cep" class="form-control"><br>
    </div>
    <br>
    <br>
    <div class="row">
