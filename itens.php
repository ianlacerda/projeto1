<?php 
    include("conexao.php") ;
    try{
        $sql = "insert into tbl_itens (preco,nome,estoque) values(:preco,:nome,:estoque)";
        $stmt = $con->prepare($sql);
        $stmt->bindValue(":preco", $_POST["preco"]);
        $stmt->bindValue(":nome", $_POST["nome"]);
        $stmt->bindValue(":estoque", $_POST["preco"]);
        $stmt->execute();
...
<body>
    ...
    <form method="post">
    <div class="row">
    <label class="form-label">Preço</label><input type="number" name="preco" class="form-control" ><br>
    </div>
    <br>
    <div class="row">
    ...
    <br>
    <div class="row">
    <label class="form-label">Estoque</label><input type="number" name="estoque" class="form-control"><br>
    </div>
    <br>
    <br>
    <div class="row">
